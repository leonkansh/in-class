...
const WIDTH = 255;
const FILL = '#d3d3d3';
const NS = 'http://www.w3.org/2000/svg'; // NS -> namespace
...
p.innerHTML = '<strong>Hello Circle Wrold!</strong>';
...
let rect = document.createElement(NS, 'rect');
...
let svgWrapper = document.querySelector('.svg-wraper');
document.querySelector()

// Function to render a circle in a parent element
function renderCircle(coord, parent) {
    // Create the circle
    let circle = document.createElement(NS, 'circle');
    circle.setAttribute('cx', coord.x);
    circle.setAttribute('cy', coord.y);
    circle.setAttribute('r', 10); // do something cool here later
